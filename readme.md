...
will attempt to match within the full path of each candidate directory. [Tab completion](#navigation-helper-expansions) is available for these three helpers.
